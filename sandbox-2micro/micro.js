...
export async function micro_init(module='micro', ...args){
  ...
  if (typeof internal_wrapper !== 'undefined') {
    ...
    return _micro_init(module, ...args);
  }
}
  
function _micro_init(module, mount_func) {
    ...
    if (MICRO_PROJECT_URL) {Com.add_project_link(MICRO_PROJECT_URL, module, "label[for=msd]");};
